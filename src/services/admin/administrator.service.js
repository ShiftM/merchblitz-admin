...
export default class AdministratorService {
    ...
    list(data) {
        promise = api.client.get(config.end_point.admin.management.administrator , {params: data});
        return promise;
    }

    show(id, data) {
        promise = api.client.get(config.end_point.admin.management.administrator + '/' + id, {params: data});
        return promise;
    }
